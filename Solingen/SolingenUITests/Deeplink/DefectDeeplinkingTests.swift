...
final class DefectDeeplinkingTests: DeeplinkingTestSuite {
  ...
  /// is it possible to open the defect deeplink
  /// **please turn off search enginge suggestions in Safari settings of the simulator**
  func testDeeplinkDefect() throws {
    openDeeplink(deeplink: "solingen://defect/")
  }// end func testDeeplinkDefect
}// end final class DefectDeeplinkingTests
#endif
#endif
