...
//  OSCASolingen
//
//  Created by Stephan Breidenbach on 29.10.21.
...
extension ServiceData: OSCAParseClassObject {}

extension ServiceData: Equatable {}

extension ServiceData {
  /// Parse class name
  public static var parseClassName : String { return "ServiceData" }
}// end extension ServiceData
